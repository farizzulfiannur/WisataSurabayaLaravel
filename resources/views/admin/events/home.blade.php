...
<body>
    <section class="navigasi mb-4"><!DOCTYPE html>
        <html lang="en">
            ...
            <section>
                ...
                <div class="container">
                    <div class="d-flex justify-content-end mb-2">
                        <a href="{{ route('add_event') }}" class="btn btn-primary" role="button"><i
                        ...
                        <tbody>
                            ...
                            @foreach ($event as $ev)
                                <tr>
                                    ...
                                    <td>{{ $ev->dest_desc }}</td>
                                    <td>
                                            @foreach ($ev->photoevent as $photo )
                                                <img src="{{ asset('event/' . $photo->photoevent) }}" alt="image" height="40px"
                                                    width="40px">
                                            @endforeach
                                    </td>
                                    <td>
                                        <div class="row">
                                            <div class="col-5">
                                                <a href="{{ route('edit_event', [$ev->id]) }}" class="btn btn-success" role="button"><i
                                                        class="fas fa-edit"></i></a>
                                            </div>
                                            <div class="col-5">
                                                <a href="{{ route('delete_event', [$ev->id]) }}" class="btn btn-danger"
